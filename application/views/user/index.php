            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down"
                        ...
                        di Courses <span style="font-size: 40px;">👋🏻
                        </span> </h1>
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900"
                        data-aos="fade-right">
                        <a href="<?=base_url('user/beginner')?>">
                            <div class="card-kelas text-center">
                                <img src="<?=base_url('assets/')?>img/beginner.png" style="object-fit: cover;"
                    ...
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900"
                        data-aos="fade-down">
                        <a href="<?=base_url('user/inter')?>">
                            <div class="card-kelas">
                                <img src="<?=base_url('assets/')?>img/inter.png" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center" data-aos-duration="1900"
                        data-aos="fade-left">
                        <a href="<?=base_url('user/expert')?>">
                            <div class="card-kelas">
                                <img src="<?=base_url('assets/')?>img/expert.png" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
                </div>
