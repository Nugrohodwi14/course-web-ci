...
<head>
    ...
    <title>Courses - Belajar Dimana Saja & Kapan Saja !</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="tel:+6285225502810">085225502810</a>
                </div>
            </div>
        </div>
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?=base_url('welcome')?>"><img
                            src="<?=base_url('assets/')?>img/.png" alt=""></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item submenu dropdown" id="navcourses">
                                <a href="<?=base_url('welcome/courses')?>" class="nav-link dropdown-toggle"
