    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?=base_url('welcome/tentang')?>">Tentang Courses</a></li>
                        <li><a href="<?=base_url('welcome/materi')?>">Materi Courses</a></li>
                        <li><a href="<?=base_url('welcome/kontak')?>">Kontak Courses</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="<?=base_url('welcome/login_guru')?>">Untuk Guru</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="#">Nugroho Dwi Yulianto</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Courses</h4>
                <p>
                    Courses adalah website pembelajaran dimana para siswa dapat belajar dimana saja dan kapan saja.
                    dan guru dapat mengupload video dirinya sendiri sedang mengajar. 
                </p>
            </div>
        </div>
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                Made with <span class="text-danger"> &#10084;</span> by nugrohodwi
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
